...
+ Workshop-Rückspulen {#workshop-rewind}
   + Verschmelzung {#fusion}
      ...
      + [Grundlegende Workfront-APIs](workshop-rewind/fusion/basic-workfront-apis.md)
      ...
      + [McKesson Fusion-Ressourcenautomatisierung](workshop-rewind/fusion/mckesson-fusion-automation.md)
   ...
   + Workflow {#workflow}
      ...
      + [Verbesserte benutzerdefinierte Forms und Lokalisierung](workshop-rewind/workflow/enhanced-logic-localization.md)
      ...
      + [Einführung in erweiterte Unternehmensabläufe](workshop-rewind/workflow/intro-aeo.md)
      + [Lektionen von Workfront-Administratoren](workshop-rewind/workflow/lessons-learned-admins.md)
      + [Beherrschen von Geschäftsregeln](workshop-rewind/workflow/business-rules.md)
      ...
      + [Workfront Admin - 10 Lektionen](workshop-rewind/workflow/workfront-admin-10-lessons.md)
...
+ Experteneinblicke {#expert-insights}
   ...
   + [Entwicklung einer Instanz](expert-insights/evolution-of-an-instance.md)
   + [Verschmelzung](expert-insights/fusion.md)
   + [Governance und Exzellenzzentren](expert-insights/centers-of-excellence.md)
   + [Haupttextmodus](expert-insights/text-mode.md)
