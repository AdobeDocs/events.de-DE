...
* **Kerntechnologien** Web-Komponenten werden mithilfe von drei Kerntechnologien erstellt** benutzerdefinierten Elementen, Schatten-DOM und HTML-Vorlagen.
...
* **Progressive Enhancement** Web-Komponenten können bestehende HTML verbessern, ohne die Funktionalität zu beeinträchtigen, wenn JavaScript nicht geladen werden kann.
